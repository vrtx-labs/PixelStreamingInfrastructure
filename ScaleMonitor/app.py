...
name = "vds-signallingwebserver"
namespace = "vds"

def getPods():
    ret = client.CoreV1Api().list_namespaced_pod("vds", label_selector="app.kubernetes.io/component=signallingwebserver")
    totalPods = len(ret.items)
    return totalPods

# redis connection
r = redis.Redis(host="vds-redis", port=6379, db=0)
