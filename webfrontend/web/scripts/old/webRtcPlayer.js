  ...
  function webRtcPlayer(parOptions) {
    ...
    setupDataChannel = function (pc, label, options) {
      try {
        ...
        datachannel.onclose = function (e) {
          ...
          // 2021-10-28: MV - add this hook
          if (self.onDataChannelClosed){
    ...
    handleCreateOffer = function (pc) {
      pc.createOffer(self.sdpConstraints).then(function (offer) {
        // FIX: https://answers.unrealengine.com/questions/1015825/pixel-streaming-error-after-chrome-updated.html
