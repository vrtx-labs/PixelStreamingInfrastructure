...
// With modifications from Oracle and VRTX Labs.
...
var disableJsonSend = config.DisableJsonSend;
...
streamerServer.on('connection', function (ws, req) {
  ...
  // MV: use the client config provider extension instead
 	if(!disableJsonSend){
